 ...
 * 删除重复的错误命名的环境变量
 * 
 * 使用方法�? * VERCEL_TOKEN=your-token pnpm tsx scripts/remove-duplicate-env-vars.ts
 */
...
// 需要删除的错误变量�?const VARS_TO_REMOVE = [
